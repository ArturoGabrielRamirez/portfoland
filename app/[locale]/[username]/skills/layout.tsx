/**
 * Public Skills Layout
 *
 * Minimal layout for public skill tree pages.
...
interface PublicSkillsLayoutProps {
...
export default async function PublicSkillsLayout({
  children,
  params,
}: PublicSkillsLayoutProps) {
