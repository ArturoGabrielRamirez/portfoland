...
- [x] 2.0 Build the Dashboard Services page
  - [x] 2.1 Create `app/[locale]/(dashboard)/dashboard/services/page.tsx`
  ...
  - [x] 2.2 Create `app/[locale]/(dashboard)/dashboard/services/DashboardServicesView.tsx`
  ...
  - [x] 2.3 Implement the inline add/edit form
  ...
  - [x] 2.4 Implement the service cards list
...
- [x] 3.0 Build the Dashboard Testimonials page
  - [x] 3.1 Create `app/[locale]/(dashboard)/dashboard/testimonials/page.tsx`
  ...
  - [x] 3.2 Create `app/[locale]/(dashboard)/dashboard/testimonials/DashboardTestimonialsView.tsx`
    - Mark as `'use client'`
  ...
  - [x] 3.3 Implement the inline add/edit form
  ...
  - [x] 3.4 Implement the testimonial cards list
...
- [x] 4.0 Build the Dashboard Gallery page
  - [x] 4.1 Create `app/[locale]/(dashboard)/dashboard/gallery/page.tsx`
    - Mirror exact structure of `app/[locale]/(dashboard)/dashboard/projects/page.tsx`
    - Auth guard + `prisma.user.findUnique` (same fields: `id, name, email, username, image, portfolioMode`)
  ...
  - [x] 4.2 Create `app/[locale]/(dashboard)/dashboard/gallery/DashboardGalleryView.tsx`
    - Mark as `'use client'`
  ...
  - [x] 4.3 Implement the inline add/edit form
    ...
    - Cancel button resets form state
  - [x] 4.4 Implement the gallery cards list
    - Each card: same `bg-[hsl(200,30%,8%)] border border-[hsl(174,100%,50%,0.15)]` card style
...
- [x] 5.0 Add Classic Mode theme picker and section visibility toggles
  - [x] 5.1 Modify `app/[locale]/(dashboard)/dashboard/portfolio/page.tsx`
  ...
  - [x] 5.2 Extend `DashboardPortfolioView.tsx` props interface
    ...
    - Extend the `sectionVisibility` default value to include Classic sections:
      ...
      ```
  - [x] 5.3 Add the "Classic Mode Theme" HUDPanel
  ...
  - [x] 5.4 Add Classic section visibility toggles to the section order area
