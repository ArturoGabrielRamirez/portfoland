...
import { ConsolePanelCard, HexagonAvatar, HexagonStatCard, AnimatedSection, CyberpunkScreen, GiantFlipCard, CRTScanLine, HexagonFeatureCard, CyberpunkGlow, CyberpunkTooltip, CyberpunkLightStrip, CyberpunkSpotlight, QuickAccessWithSpotlights, QuickAccessWithStaticSpotlights } from '@/features/dashboard/components'
            ...
            <div className="flex items-center gap-4 h-full">
              ...
              <div className="flex-1 min-w-0">
                ...
                <p className="text-sm text-[#94A3B8] mb-2 truncate">{t('welcomeSubtitle')}</p>
                 ...
                 <QuickAccessWithStaticSpotlights locale={locale} userId={user.id} />
              </div>
            </div>
          </div>
